...
<body>
	<?php include("include/navbardepan.php"); ?>
	<br><br><br><br>
	<div class="container">
		<article class="row">
			<section class="col-lg-8">
				<?php
					if(isset($_GET['searchdepan'])){
					echo'
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
										...
										<div class="col-sm-8">
											...
											<a href="postdepan.php?post_id='.$row['id'].'" class="btn btn-primary">Read more</a>
										</div>
								</div>
							</div>
						';
			...
			<?php
				include("include/sidebardepan.php"); 
			?>
			</aside>
		</article>
	</div>
